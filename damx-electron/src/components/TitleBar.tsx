 ...
 */
import type { ConnectionState } from '../state/damx';
    ...
    <header className="titlebar">
      ...
      <div className="titlebar-right">
        ...
        <div className="window-controls">
          <button type="button" aria-label="Minimize" onClick={() => window.damx.window.minimize()}>
            <svg width="11" height="11" viewBox="0 0 11 11"><rect x="1" y="5" width="9" height="1" fill="currentColor" /></svg>
          </button>
          <button type="button" aria-label="Maximize" onClick={() => window.damx.window.maximize()}>
            <svg width="11" height="11" viewBox="0 0 11 11"><rect x="1.5" y="1.5" width="8" height="8" fill="none" stroke="currentColor" /></svg>
          </button>
          <button type="button" aria-label="Close" className="close" onClick={() => window.damx.window.close()}>
